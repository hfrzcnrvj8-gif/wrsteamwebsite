      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="hidden h-10 place-items-center rounded-full border border-brand-red px-5 text-sm font-semibold text-brand-red transition-colors hover:bg-brand-red hover:text-white sm:grid"
          >
            {dict.book}
          </Link>
        </div>
